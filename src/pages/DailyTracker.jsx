...
//       // Skip the prayer question as it's handled separately
//       goToNextQuestion();
//       return;
//     }
...
//             <button
//               onClick={handleEdit}
//               className="flex items-center text-islamic hover:text-islamic-dark"
//             >
//               <HiPencil className="w-5 h-5 mr-1" />
//               পুনরায় জমা দিন
//             </button>
//           </div>
//           <h2 className="text-2xl font-bold text-islamic mb-4">
...
//             </span>
//           </p>
//           <p className={`text-lg font-semibold ${className} mb-4`}>{message}</p>
//         </div>
//       </div>
//     );
//   }
...
//     Object.keys(answers).length === amalQuestions.length - 1; // Excluding prayer question
...
//             <h2 className="text-2xl font-semibold text-islamic">
//               {question.question}
//             </h2>
//             <button
//               onClick={() => {
...
//                   isAnswered && answers[currentQuestion] ? "bg-green-600" : ""
//                 }`}
//               >
//                 সম্পন্ন করেছি
//               </button>
...
//                   isAnswered && !answers[currentQuestion] ? "bg-red-100" : ""
//                 }`}
//               >
//                 সম্পন্ন করি নি
//               </button>
